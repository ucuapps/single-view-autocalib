...
//          INTERFACE FUNCTION
//---------------------------------------------------------------------
void Canny(Mat &gray, double alpha, int low, int high,
...
void Canny(Mat &gray, double alpha, int low, int high, vector<Contour> &contours)
{
    vector<Vec4i> hierarchy;
    Canny(gray, alpha, low, high, contours, hierarchy, RETR_LIST);
}
